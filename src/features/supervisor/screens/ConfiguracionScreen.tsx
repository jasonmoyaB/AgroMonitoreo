...
import { CambiarPasswordForm, DatosPersonalesForm, EditarNombreForm } from '../../perfil'
      ...
      <div className="flex h-full min-w-0 flex-col gap-3 md:flex-row md:gap-4">
        ...
        <section className="min-h-0 min-w-0 flex-1 overflow-y-auto overscroll-contain">
          <header className="neu-raised mb-4 rounded-[2rem] p-5">
            ...
            <p className="mt-2 font-bold leading-7 text-slate-600">Edita tu nombre, tu contraseña de acceso y tus datos de contacto.</p>
          </header>
          ...
          {isLoading || !usuario ? (
            ...
            <div className="grid gap-3 md:grid-cols-2 md:gap-4">
              ...
              <div className="md:col-span-2">
                <DatosPersonalesForm usuarioId={usuario.id} />
              </div>
            </div>
          )}
        </section>
