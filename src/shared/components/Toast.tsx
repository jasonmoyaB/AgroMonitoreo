...
export function Toast({ toast }: ToastProps) {
  ...
  return (
    <div role="status" className={`animate-toast-pop pointer-events-auto flex min-w-64 max-w-sm items-start gap-3 rounded-2xl px-5 py-4 text-white shadow-xl ${toneClass}`}>
