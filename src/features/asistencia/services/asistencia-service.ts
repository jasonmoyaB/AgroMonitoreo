...
export async function marcarAusente(fincaId: string, trabajadorId: string, fecha: string, client: SupabaseClient = supabase): Promise<void> {
  return registrarAusencias(fincaId, trabajadorId, [fecha], client)
}
