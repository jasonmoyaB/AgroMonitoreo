...
| Modal de métricas de trabajador (horas/cantidad/productividad + PDF) | `src/features/trabajadores/components/TrabajadorMetricasModal.tsx` + `hooks/use-trabajador-metricas-modal.ts` (hosteado por `supervisor/screens/TrabajadoresCrudScreen.tsx` y `admin/screens/TrabajadoresPorFincaScreen.tsx`) |
